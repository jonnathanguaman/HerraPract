    ...
    schemas: {
      ...
      DashboardResumen: {
        ...
        properties: {
          ...
          productosStockBajo: { type: "array", items: { $ref: "#/components/schemas/Producto" } },
          ventasHoy: { type: "integer" },
          totalVendidoHoy: { type: "number", format: "float" },
          ventasRecientes: { type: "array", items: { $ref: "#/components/schemas/Venta" } },
          productosMenorStock: { type: "array", items: { $ref: "#/components/schemas/Producto" } },
          stockBajoUmbral: { type: "integer", example: 5 },
        },
      },
      ReporteVentas: {
        type: "object",
        properties: {
          ...
          totalVentas: { type: "integer" },
          totalVendido: { type: "number", format: "float" },
          ventas: { type: "array", items: { $ref: "#/components/schemas/Venta" } },
          productosMasVendidos: { type: "array", items: { type: "object" } },
        },
      },
    },
    responses: {
  ...
  paths: {
    ...
    "/api/dashboard/resumen": {
      get: {
        ...
        responses: {
          200: {
            description: "Metricas, ventas recientes y productos con stock bajo",
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/DashboardResumen" } },
            },
          },
          401: { $ref: "#/components/responses/Unauthorized" },
        },
    ...
    "/api/reportes/ventas": {
      get: {
        ...
        responses: {
          200: {
            description: "Totales y productos mas vendidos del rango",
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/ReporteVentas" } },
            },
          },
          400: { $ref: "#/components/responses/BadRequest" },
          401: { $ref: "#/components/responses/Unauthorized" },
